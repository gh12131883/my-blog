...
public class BoardDslRepositoryImpl implements BoardDslRepository {
    ...
    @Override
    public BoardDto findBoardDto(long boardCollectionId, long boardId){
//        BoardDto fetched =
//                query.select(
//                        new QBoardDto(
...
//        return fetched;
    ...
    public List<BoardEntity> findBoards(long boardCollectionId){
...
//                .fetch();
    ...
    public Page<BoardDto> findBoardPage(long boardCollectionId, Pageable pageable){
//        List<BoardDto> fetch=
//                query.select(
//                        new QBoardDto(
//                                board.boardCollectionId,
